...
using ConsoleAppClient.Encryption;

namespace ConsoleAppClient.Impersonation
{
    public class Impersonation
    {
        ...
        private static string _sDocSRVUId = "srv_cititech_pv";
        private static string _sDDocDomain = "NAM";
        private static string _sDocSRVPswd = "E474F405FB2858DADD38270F5B5944D4";
        ...
        public bool impersonateValidUser()
        {
            try
            {
                return impersonateValidUser(SrvUID, DocDomain, Encryption.Encryption.Decrypt(SrvPWSD));
            }
            catch (Exception)
            {
                return false;
